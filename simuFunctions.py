...
def distribute_loadings_across_year(dict_annual_loads, dict_applications, df_distributions, link, my_tf):
    ...
    my_dbl_dict_data = {i: {c: 0.0 for c in dict_applications[link]} for i in my_tf.series_simu}
    ...
    for contaminant in dict_applications[link]:
        for my_dt_data in my_tf.series_data[1:]:
            ...
            for my_sub_step in range(0, -divisor, -1):
                ...
                my_dbl_dict_data[my_dt_simu][contaminant] = my_portion

    return my_dbl_dict_data
